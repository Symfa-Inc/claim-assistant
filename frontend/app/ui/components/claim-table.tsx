        ...
        <table className="w-full table-fixed text-left text-[13px] text-slate-600">
          <thead>
            <tr className="border-b border-slate-100">
              <th className="pb-2.5 pr-4 text-[10px] font-semibold uppercase tracking-wider text-slate-400 w-[40%]">
                Field
              </th>
              <th className="pb-2.5 pr-4 text-[10px] font-semibold uppercase tracking-wider text-slate-400">
                Value
              </th>
          ...
          <tbody className="divide-y divide-slate-100/80">
            ...
            {fields.map((field) => {
              ...
              const confidencePercent = Number.isNaN(confidenceValue)
                ? 0
                : confidenceValue;
              ...
              return (
                <tr
                  ...
                  className={`transition-all ${
                    isActive ? "bg-accent-subtle" : "hover:bg-slate-50/60"
                  }`}
                  style={
                    isActive
                      ? { boxShadow: "inset 5px 0 0 -3px #0d9488" }
                      : undefined
                  }
                    ...
                    <div className="flex h-5 items-center gap-2">
                      <div className="h-[3px] w-10 shrink-0 overflow-hidden rounded-full bg-slate-100">
                        <div
                          ...
                          style={{
                            width: `${isValidated ? 100 : confidencePercent}%`,
                          }}
                        />
                      </div>
                      <span
                        className={`inline-flex h-5 w-12 shrink-0 items-center justify-end gap-0.5 text-xs font-medium tabular-nums ${textColor}`}
                      >
                        {isValidated && (
                          <svg
                        ...
                        {isValidated ? "100%" : field.confidence}
                      </span>
                    </div>
                  </td>
                      ...
                      >
                        ...
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M15.232 5.232l3.536 3.536M9 11l6.232-6.232a2.5 2.5 0 113.536 3.536L12.536 14.536a4 4 0 01-1.414.94L8 16l.524-3.122A4 4 0 019 11z"
                          />
                        </svg>
                      </button>
                      <button
